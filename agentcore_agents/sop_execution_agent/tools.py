...
def stop_ec2_instance(instance_id: str, region: str = 'us-east-1') -> Dict[str, Any]:
    """Stop EC2 instance - DESTRUCTIVE OPERATION - Requires human approval"""
    return {
        "instance_id": instance_id,
        "action": "stop",
        "status": "requires_approval",
        "message": "DESTRUCTIVE OPERATION: Stopping EC2 instance requires human approval. Please escalate to on-call support."
    }

@tool
def reboot_ec2_instance(instance_id: str, region: str = 'us-east-1') -> Dict[str, Any]:
    """Reboot EC2 instance - DESTRUCTIVE OPERATION - Requires human approval"""
    return {
        "instance_id": instance_id,
        "action": "reboot",
        "status": "requires_approval",
        "message": "DESTRUCTIVE OPERATION: Rebooting EC2 instance requires human approval. Please escalate to on-call support."
    }
